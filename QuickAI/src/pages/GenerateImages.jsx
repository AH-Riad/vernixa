      ...
      >
          ...
          {ImageStyle.map((item, index) => (
            <span
              ...
              className={`text-xs px-4 py-1 border rounded-full cursor-pointer transition-colors ${
                selectedStyle === item
                  ? "bg-blue-50 text-green-700 border-green-700"
        ...
        <div className="my-6 flex items-center gap-2">
          <label className="relative cursor-pointer">
            ...
            <span className="absolute left-1 top-1 w-3 h-3 bg-whiten rounded-full transition peer-checked:translate-x-4"></span>
          </label>
          ...
          <div className="flex-1 flex justify-center items-center">
            <div className="text-sm flex flex-col items-center gap-5 text-gray-400">
              ...
              <p className="text-slate-500">
                Enter a topic and click ❝Generate image❞ to get strated
              </p>
            </div>
          </div>
        ) : (
